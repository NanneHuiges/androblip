...
import com.huiges.AndroBlip.DynamicListViewAdapter;
...
public class DynamicListView extends ListView {
    ...
    private final int LINE_THICKNESS = 11;

    public ArrayList<String> mBlipViewList;
    ...
    private Bitmap getBitmapWithBorder(View v) {
    	v.setBackgroundColor(getResources().getColor(R.color.link));
    ...
    public boolean onTouchEvent (MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
            	...
            	int position = lv.pointToPosition((int) mDownX, (int) mDownY);
            	mTotalOffset = 0;
                ...
                if( ! mCellIsMobile && selectedView != null ){
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mBlipViewList, originalItem, getPositionForView(switchView));
            
            FragmentPreference.setBlipViews(getContext(), mBlipViewList);
